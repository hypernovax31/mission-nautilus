...
MOTS_CANDIDATS = [
    dict(reponse='DEMATERIALISATION', secteur='rayon',     mode=None,
         indice="le fantôme du produit : il existe sans occuper de place"),
    dict(reponse='TRANSFORMATION',    secteur='direction', mode=None,
         indice="le tour de passe-passe du seuil à la caisse"),
    dict(reponse='STEELBOOK',         secteur='rayon',     mode=None,
         indice="le boîtier qui vaut son pesant d'acier"),
    dict(reponse='DIAGNOSTIC',        secteur='sav',       mode=None,
         indice="le mal de la machine, avoué en grec"),
    dict(reponse='REASSORT',          secteur='stock',     mode=None,
         indice="la seconde venue des produits, avant le réveil du magasin"),
    dict(reponse='PICKING',           secteur='stock',     mode=None,
         indice="la cueillette qui n'a pas trouvé son mot français"),
    dict(reponse='INVENTAIRE',        secteur='bureau',    mode=None,
         indice="l'in-vente passé au peigne fin, une nuit par an"),
    dict(reponse='PLEIADE',          secteur='rayon',     mode=None,
         indice="sept sœurs entre deux couvertures"),
    dict(reponse='PLANOGRAMME',       secteur='direction', mode=None,
         indice="l'ordonnance des rayons, au gramme près"),
    dict(reponse='FACING',            secteur='rayon',     mode=None,
         indice="faire front au rayon, en franglais"),
]
