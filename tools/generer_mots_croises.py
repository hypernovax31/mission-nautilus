...
MOTS_CANDIDATS = [
    dict(reponse='DEMATERIALISATION', secteur='rayon',     mode=None,
         indice="quand la marchandise renonce à son corps pour ne plus être qu'un droit d'accès"),
    dict(reponse='TRANSFORMATION',    secteur='direction', mode=None,
         indice="le taux qui dit combien de passants deviennent acheteurs"),
    dict(reponse='STEELBOOK',         secteur='rayon',     mode=None,
         indice="l'écrin de métal qui enveloppe un film de collection"),
    dict(reponse='DIAGNOSTIC',        secteur='sav',       mode=None,
         indice="la sentence rendue après l'écoute des symptômes d'une machine"),
    dict(reponse='REASSORT',          secteur='stock',     mode=None,
         indice="regarnir un rayon vidé avant l'ouverture"),
    dict(reponse='PICKING',           secteur='stock',     mode=None,
         indice="composer une commande article par article dans les allées du dépôt"),
    dict(reponse='INVENTAIRE',        secteur='bureau',    mode=None,
         indice="compter tout ce que recèlent la réserve et les rayons"),
    dict(reponse='PLEIADE',          secteur='rayon',     mode=None,
         indice="le cercle des sept poètes, devenu collection à reliure d'or"),
    dict(reponse='PLANOGRAMME',       secteur='direction', mode=None,
         indice="le schéma qui fixe la place de chaque produit dans le rayon, dicté par le siège"),
    dict(reponse='FACING',            secteur='rayon',     mode=None,
         indice="mettre chaque produit au premier rang, au bord de l'étagère"),
]
