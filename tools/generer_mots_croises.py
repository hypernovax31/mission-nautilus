...
MOTS_CANDIDATS = [
    ...
    dict(reponse='REPRISE',          secteur='sav',       mode=None,
         indice="la seconde existence qu'on accorde à l'objet usé, contre un bon d'achat"),
    ...
    dict(reponse='NEURONAL',         secteur='rayon',     mode=None,
         indice="le tissu de la machine qui singe le cerveau pour flairer et décider"),
    dict(reponse='DIAPHRAGME',       secteur='rayon',     mode=None,
         indice="l'iris de l'objectif qui dose la lumière pour sculpter le flou et la netteté"),
    dict(reponse='ANTISKATING',      secteur='rayon',     mode=None,
         indice="le contrepoids qui retient le bras de s'égarer vers le cœur du sillon"),
    dict(reponse='DEFROISSEUR',      secteur='rayon',     mode=None,
         indice="le souffle vertical qui redresse l'étoffe sans jamais la toucher"),
