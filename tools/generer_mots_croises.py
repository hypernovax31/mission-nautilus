...
MOTS_CANDIDATS = [
    dict(reponse='DEMATERIALISATION', secteur='rayon',     mode=None,
         indice="l'effacement de l'objet au profit du nuage"),
    dict(reponse='TRANSFORMATION',    secteur='direction', mode=None,
         indice="la proportion qui juge le flux entre l'entrée et la caisse"),
    dict(reponse='STEELBOOK',         secteur='rayon',     mode=None,
         indice="la seconde peau de métal qui enveloppe le film"),
    dict(reponse='DIAGNOSTIC',        secteur='sav',       mode=None,
         indice="le verdict qui sépare la panne de la fausse manip"),
    dict(reponse='REASSORT',          secteur='stock',     mode=None,
         indice="combler les creux du rayon avant le jour"),
    dict(reponse='PICKING',           secteur='stock',     mode=None,
         indice="la récolte à l'aveugle au fond de la réserve"),
    dict(reponse='INVENTAIRE',        secteur='bureau',    mode=None,
         indice="la nuit où le chiffre s'incline devant le réel"),
    dict(reponse='PLEIADE',          secteur='rayon',     mode=None,
         indice="le papier bible sous la couverture souple ourlée d'or"),
    dict(reponse='PLANOGRAMME',       secteur='direction', mode=None,
         indice="la géométrie du rayon, décrétée par le siège"),
    dict(reponse='FACING',            secteur='rayon',     mode=None,
         indice="le garde-à-vous des produits au rebord du rayon"),
]
