...
MOTS_CANDIDATS = [
    ...
    dict(reponse='PLEIADE',          secteur='rayon',     mode=None,
         indice="le sommet de la librairie : ces éditions précieuses à la couverture souple et aux pages ourlées d'or, qu'on conseille pour un cadeau mémorable et qu'on ne remise jamais en réserve"),
