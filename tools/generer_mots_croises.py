...
MOTS_CANDIDATS = [
    dict(reponse='DEMATERIALISATION', secteur='rayon',     mode=None,
         indice="la boîte vidée de son ombre : le produit ne vit plus que dans la mémoire du réseau"),
    dict(reponse='TRANSFORMATION',    secteur='direction', mode=None,
         indice="la porte qui filtre la foule : combien d'entrées laissent un sac, combien repartent les mains vides"),
    dict(reponse='STEELBOOK',         secteur='rayon',     mode=None,
         indice="l'armure du film : le coffret qui pèse dans la main du collectionneur"),
    dict(reponse='DIAGNOSTIC',        secteur='sav',       mode=None,
         indice="l'auscultation du comptoir : écouter la machine pour dire si elle souffre ou si l'on s'est trompé"),
    dict(reponse='REASSORT',          secteur='stock',     mode=None,
         indice="le jardinier de l'aube : regarnir les étagères avant que le magasin ne s'éveille"),
    dict(reponse='PICKING',           secteur='stock',     mode=None,
         indice="le moissonneur des allées : cueillir, sans jamais le voir, ce qu'un client fantôme a demandé"),
    dict(reponse='INVENTAIRE',        secteur='bureau',    mode=None,
         indice="la pesée de minuit : quand le magasin compte ses grains un à un sous la lampe"),
    dict(reponse='PLEIADE',          secteur='rayon',     mode=None,
         indice="la noblesse du papier : la robe souple et dorée qui distingue le livre qu'on garde toute une vie"),
    dict(reponse='PLANOGRAMME',       secteur='direction', mode=None,
         indice="la carte au trésor du rayon : le dessin officiel qui assigne à chaque objet sa case"),
    dict(reponse='FACING',            secteur='rayon',     mode=None,
         indice="le salut du soldat : chaque produit au garde-à-vous, poitrine au bord de la tablette"),
]
