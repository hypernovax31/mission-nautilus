...
MOTS_CANDIDATS = [
    dict(reponse='DEMATERIALISATION', secteur='rayon',     mode=None,
         indice="l'âme sans corps de la marchandise, vendue quand même"),
    dict(reponse='TRANSFORMATION',    secteur='direction', mode=None,
         indice="la balance invisible qui pèse ceux qui entrent contre ceux qui paient"),
    dict(reponse='STEELBOOK',         secteur='rayon',     mode=None,
         indice="la cotte de mailles que revêt le film pour les éditions de collection"),
    dict(reponse='DIAGNOSTIC',        secteur='sav',       mode=None,
         indice="l'enquête du médecin menée sur un patient qui ne dit mot"),
    dict(reponse='REASSORT',          secteur='stock',     mode=None,
         indice="la seconde vie du rayon, donnée avant que la journée ne commence"),
    dict(reponse='PICKING',           secteur='stock',     mode=None,
         indice="le geste du verger répété dans un entrepôt sans arbre"),
    dict(reponse='INVENTAIRE',        secteur='bureau',    mode=None,
         indice="la photographie de nuit où chaque objet doit comparaître au moins une fois"),
    dict(reponse='PLEIADE',          secteur='rayon',     mode=None,
         indice="les filles du titan qui porte le ciel, réunies en un seul volume"),
    dict(reponse='PLANOGRAMME',       secteur='direction', mode=None,
         indice="le cadastre que le marchand punaise pour retrouver chaque objet les yeux fermés"),
    dict(reponse='FACING',            secteur='rayon',     mode=None,
         indice="la haie d'honneur des produits, poitrine au bord du rayon"),
]
