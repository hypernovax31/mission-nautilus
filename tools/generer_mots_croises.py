...
MOTS_CANDIDATS = [
    ...
    dict(reponse='PICKING',           secteur='stock',     mode=None,
         indice="le ballet du e-réservoir : la tournée, liste en main, qui relie les allées de la réserve pour rassembler une à une les références d'un client qu'on ne verra jamais en caisse"),
    ...
    dict(reponse='REGULATION',        secteur='rayon',     mode=None,
         indice="le climat sans météo : la boucle silencieuse qui maintient la même fraîcheur d'un bout à l'autre du navire, des rayons aux réserves, sans qu'aucun matelot n'y touche"),
